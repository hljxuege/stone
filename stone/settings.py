...
import os
import __dump__
PROJECT_HOME = PROJECT_PATH = os.path.dirname(__dump__.__file__)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'stone',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '2&b1vc^cgll(4uf7pyo9!%t#pmt#71m@i%)&r&yad&a5j_o9p)'
